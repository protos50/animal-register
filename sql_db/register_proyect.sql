...
INSERT INTO ROLE (ROLE_NAME) VALUES ('COLLECTOR'), ('IDENTIFIER');

CREATE TABLE PERSON_ROLE (
    ID_PERSON INTEGER NOT NULL,
    ID_ROLE INTEGER NOT NULL,
    IS_ACTIVE BOOLEAN DEFAULT FALSE,
    CONSTRAINT FK_PERSON_ROLE_PERSON FOREIGN KEY (ID_PERSON) REFERENCES PERSON (ID_PERSON),
    CONSTRAINT FK_PERSON_ROLE_ROLE FOREIGN KEY (ID_ROLE) REFERENCES ROLE (ID_ROLE),
    CONSTRAINT PK_PERSON_ROLE PRIMARY KEY (ID_PERSON, ID_ROLE)
);


INSERT INTO PERSON_ROLE (id_person, id_role, is_active) VALUES (1, 1, TRUE);
...
CREATE TABLE COLLECTION (
    ...
    CONSTRAINT FK_COLLECTION_PERSON FOREIGN KEY (ID_PERSON) REFERENCES PERSON (ID_PERSON),
